...
# Split into a language-neutral set + a C++-only set; gcc rejects C++-specific
# flags (e.g. -Wno-self-move, -fcheck-new) when compiling C.
set(GCC_AGGRESSIVE_COMPILE
  ...
  -Wswitch-default -Werror=vla
  -Wsign-conversion -Wstrict-overflow=2 -Wsuggest-attribute=noreturn -Wunused
  -Wno-varargs -fstrict-overflow -fno-omit-frame-pointer -Winline
...
# Additional warnings/options that only make sense for C++.
set(GCC_AGGRESSIVE_COMPILE_CXX_ONLY
  -Wsuggest-final-methods -Wsuggest-final-types
  -fcheck-new -Wno-self-move
)
...
target_compile_options(project_options INTERFACE
  ...
  $<$<COMPILE_LANG_AND_ID:C,GNU,Clang>: ${GCC_BASE_COMPILE}>
  ...
  $<$<AND:$<CONFIG:Debug>,$<COMPILE_LANG_AND_ID:CXX,GNU,Clang>>: ${GCC_DEBUG_COMPILE} ${GCC_AGGRESSIVE_COMPILE} ${GCC_AGGRESSIVE_COMPILE_CXX_ONLY}>
  $<$<AND:$<CONFIG:Debug>,$<COMPILE_LANG_AND_ID:C,GNU,Clang>>: ${GCC_DEBUG_COMPILE} ${GCC_AGGRESSIVE_COMPILE}>
  ...
  $<$<AND:$<CONFIG:RelWithDebInfo>,$<COMPILE_LANG_AND_ID:C,GNU,Clang>>: ${GCC_RELWITHDEB}>
  ...
  $<$<AND:$<CONFIG:Release>,$<COMPILE_LANG_AND_ID:C,GNU,Clang>>: ${GCC_RELEASE}>
...
target_link_options(project_options INTERFACE
  ...
  $<$<COMPILE_LANG_AND_ID:C,GNU,Clang>: ${GCC_BASE_LINK}>
